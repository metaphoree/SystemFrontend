...
import { WrapperMonthRecievableVM } from 'src/Modules/primary/domainModels/monthly-report/recievable/WrapperMonthRecievableVM';
...
@Component({
  selector: 'app-recievable-report',
  templateUrl: './recievable-report.component.html',
  styleUrls: ['./recievable-report.component.css']
})
export class RecievableReportComponent implements OnInit {
  ...
  wrapperItemList: WrapperMonthRecievableVM;
  totalAmount: number;
  constructor(private util: UtilService,
    ...
    this.wrapperItemList = new WrapperMonthRecievableVM();
  ...
  public DoDBOperation(operationType: DB_OPERATION, item: any): void {
    ...
    console.log(URL);
    this.baseService.set<WrapperMonthRecievableVM>(URL, item)
      .subscribe((data) => {
