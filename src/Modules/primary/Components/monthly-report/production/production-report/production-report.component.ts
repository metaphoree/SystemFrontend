...
import { WrapperMonthProductionListVM } from 'src/Modules/primary/domainModels/monthly-report/production/WrapperMonthProductionListVM';
...
export class ProductionReportComponent implements OnInit {
  ...
  wrapperItemList: WrapperMonthProductionListVM;
  totalAmount: number;
  constructor(private util: UtilService,
    ...
    this.wrapperItemList = new WrapperMonthProductionListVM();
  ...
  public DoDBOperation(operationType: DB_OPERATION, item: any): void {
    ...
    console.log(URL);
    this.baseService.set<WrapperMonthProductionListVM>(URL, item)
      .subscribe((data) => {
        this.wrapperItemList.ListOfData = data.ListOfData;
      //  this.wrapperItemList.ListOfData[this.wrapperItemList.ListOfData.length - 1]. = "Total Amount : ";
        this.totalAmount = this.wrapperItemList.ListOfData[this.wrapperItemList.ListOfData.length - 1].TotalAmount;
