...
import { WrapperSupplierHistory } from 'src/Modules/primary/domainModels/history/supplier/WrapperSupplierHistory';
...
export class SupplierHistoryComponent implements OnInit {
  ...
  public wrapperItemList: WrapperSupplierHistory;
  ...
  public selectedCustomer: SupplierVM;
  columnList: any;
  constructor(private baseService: BaseServiceService,
    ...
    this.wrapperItemList = new WrapperSupplierHistory();
    this.selectedCustomer = new SupplierVM();
  ...
  GetInitialData(): void {
    ...
    this.baseService.set<WrapperSupplierHistory>(ApiUrl.GetSupplierHistory, this.getDataListVM)
      .subscribe((data) => {
  ...
  SelectedCustomer(event): void {
    this.getDataListVM.PageNumber = 1;
    this.getDataListVM.PageSize = 100;
    let customer: SupplierVM = event.value;
  ...
  DoDBOperation(operationType: DB_OPERATION, item: any): void {
    ...
    console.log(URL);
    this.baseService.set<WrapperSupplierHistory>(URL, item)
      .subscribe((data) => {
        this.wrapperItemList.ListOfData = data.ListOfData;
        //  this.wrapperItemList.TotalRecoreds = data.TotalRecoreds;
